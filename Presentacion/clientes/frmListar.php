            ...
            <tbody>
              ...
              foreach ( $Obj_Paginador->RegistrosPaginados as $Fila ) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?mod=clie&form=de&id=<?php echo $Fila['ClienteId'];?>" class="view" title="Detalles"><i class="material-icons">&#xE417;</i></a>
                    <a href="index.php?mod=clie&form=ed&id=<?php echo $Fila['ClienteId'];?>" class="edit"><i class="material-icons" data-toggle="tooltip"
                      title="Editar">&#xE254;</i></a>
